...
public class VolumChartB extends Fragment {
    LineChart lineChart;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_volum_chart_b, container, false);
        lineChart = v.findViewById(R.id.chart);

        lineDataSet.setLabel("Volume Air B");
    ...
    void getDataVolume(){
        ...
        Call<VolumeResponse> call = service.getVolumChart("2");
