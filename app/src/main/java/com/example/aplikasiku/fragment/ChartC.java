...
public class ChartC extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url = "https://pantaukendaliair.com/chartC.php";
        ...
        lineDataSet.setLabel("Rate Air C");
    ...
    public void getData(String kolom, String tabel){
        ...
        call.enqueue(new Callback<com.example.aplikasiku.model.raterealtime.RateRealtimeResponse>() {
            ...
            public void onResponse(Call<com.example.aplikasiku.model.raterealtime.RateRealtimeResponse> call, Response<com.example.aplikasiku.model.raterealtime.RateRealtimeResponse> response) {
                ...
                if (response.body().isSuccess()){
                    if (response.body().getData() != null) {
                        ...
                        for (int i = 0; i < dataList.size(); i++){
                            ...
                            lineDataSet.setLabel("Rate Gedung C");
                ...
                ShowChart(DataVals, "Rate Realtime Gedung C");
            }
