...
public class ChartPusat extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lineDataSetP.setLabel("Rate Air C");
    ...
    void getDataVolum(){
        ...
        Call<ChartRateRes> call = service.getRateChart("rateP","rate_p");
        call.enqueue(new Callback<ChartRateRes>() {
            ...
            public void onResponse(Call<ChartRateRes> call, Response<ChartRateRes> response) {
                ...
                if(response.code() == 200){
                    ...
                    lineDataSetP.setValues(DataValsA);
                    lineDataSetP.setDrawIcons(false);
                    lineDataSetP.setCircleColor(Color.rgb(3,169,244));
                    ...
                    lineDataSetP.setFillColor(Color.rgb(3,169,244));
                    lineDataSetP.setColor(Color.rgb(3,169,244));

                    lineData = new LineData(lineDataSetP);
