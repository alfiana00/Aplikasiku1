...
public class ChartD extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url = "https://pantaukendaliair.com/chartD.php";
        ...
        btnDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (!folder.exists())
                        folder.mkdir();
                    final String pdf = folder.toString() + "/Realtime Laju Air Gedung D "+ tglIni+".pdf";
        ...
        lineDataSet.setLabel("Rate Air D");
    ...
    public void getData(String kolom, String tabel){
        ...
        call.enqueue(new Callback<RateRealtimeResponse>() {
            ...
            public void onResponse(Call<RateRealtimeResponse> call, Response<RateRealtimeResponse> response) {
                ...
                if (response.body().isSuccess()){
                    if (response.body().getData() != null) {
                        ...
                        for (int i = 0; i < dataList.size(); i++){
                            ...
                            lineDataSet.setLabel("Rate Gedung D");
                ...
                ShowChart(DataVals, "Rate Realtime Gedung D");
            }
                ...
                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    ...
                    public void onClick(final SweetAlertDialog sweetAlertDialog) {
                        ...
                        try {
                            ...
                            if (!folder.exists())
                                folder.mkdir();
                            final String pdf = folder.toString() + "/Rate Air Gedung D "+tglIni+".pdf";
                            PdfWriter.getInstance(document, new FileOutputStream(pdf));
                        } catch (FileNotFoundException fileNotFoundException) {
                            fileNotFoundException.printStackTrace();
                        } catch (DocumentException e) {
