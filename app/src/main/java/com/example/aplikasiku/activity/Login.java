            ...
            call.enqueue(new Callback<LoginResponse>() {
                ...
                public void onResponse(Call<LoginResponse> call, Response<LoginResponse> response) {
                    if (response.body().isSuccess()) {
                        ...
                        editor.putString("nama", response.body().getDataLogin().getNama());
                        editor.putString("username", response.body().getDataLogin().getUsername());
                        editor.putString("id", response.body().getDataLogin().getId());
                        editor.apply();
