...
import com.example.aplikasiku.adapter.RecyclerKebocoranDataAdapter;
...
public class Kebocoran extends AppCompatActivity {
    ...
    TextView tvTgl1, tvTgl2, titleBocor;
    TextView tvNull;
    Spinner listGedung;
    private String[] judul = {"Kebocoran Air"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleBocor = findViewById(R.id.title_status);
        ...
        cvTglAwal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(Kebocoran.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
...
//    }
                ...
                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    ...
                    public void onClick(final SweetAlertDialog sweetAlertDialog) {
                        ...
                        try {
                            ...
                            if (!folder.exists())
                                folder.mkdir();
                            final String pdf = folder.toString() + "/Kebocoran_" +gedung+ "_" +waktu1+ "_" +waktu2+ ".pdf";
                        ...
                        try {
                            ...
                            document.add(JudulText("Data Pemantauan Kebocoran Air"));
    ...
    public void downloadCsv(View view){
        ...
        da.add(new String[]{"Data Monitoring Kebocoran Air"});
        da.add(new String[]{""});
        da.add(new String[]{"Waktu","Status"});

        for (int j = 0; j < listBocor.size(); j++){
            da.add(new String[]{listWaktu.get(j), listBocor.get(j)});
        }
